...
"use strict";
eval("\r\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\r\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\r\n    return new (P || (P = Promise))(function (resolve, reject) {\r\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\r\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\r\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\r\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\r\n    });\r\n};\r\nvar __generator = (this && this.__generator) || function (thisArg, body) {\r\n    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;\r\n    return g = { next: verb(0), \"throw\": verb(1), \"return\": verb(2) }, typeof Symbol === \"function\" && (g[Symbol.iterator] = function() { return this; }), g;\r\n    function verb(n) { return function (v) { return step([n, v]); }; }\r\n    function step(op) {\r\n        if (f) throw new TypeError(\"Generator is already executing.\");\r\n        while (_) try {\r\n            if (f = 1, y && (t = op[0] & 2 ? y[\"return\"] : op[0] ? y[\"throw\"] || ((t = y[\"return\"]) && t.call(y), 0) : y.next) && !(t = t.call(y, op[1])).done) return t;\r\n            if (y = 0, t) op = [op[0] & 2, t.value];\r\n            switch (op[0]) {\r\n                case 0: case 1: t = op; break;\r\n                case 4: _.label++; return { value: op[1], done: false };\r\n                case 5: _.label++; y = op[1]; op = [0]; continue;\r\n                case 7: op = _.ops.pop(); _.trys.pop(); continue;\r\n                default:\r\n                    if (!(t = _.trys, t = t.length > 0 && t[t.length - 1]) && (op[0] === 6 || op[0] === 2)) { _ = 0; continue; }\r\n                    if (op[0] === 3 && (!t || (op[1] > t[0] && op[1] < t[3]))) { _.label = op[1]; break; }\r\n                    if (op[0] === 6 && _.label < t[1]) { _.label = t[1]; t = op; break; }\r\n                    if (t && _.label < t[2]) { _.label = t[2]; _.ops.push(op); break; }\r\n                    if (t[2]) _.ops.pop();\r\n                    _.trys.pop(); continue;\r\n            }\r\n            op = body.call(thisArg, _);\r\n        } catch (e) { op = [6, e]; y = 0; } finally { f = t = 0; }\r\n        if (op[0] & 5) throw op[1]; return { value: op[0] ? op[1] : void 0, done: true };\r\n    }\r\n};\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nvar express = __webpack_require__(/*! express */ \"express\");\r\nvar passport = __webpack_require__(/*! passport */ \"passport\");\r\nvar db_1 = __webpack_require__(/*! ../../db */ \"./src/server/db/index.ts\");\r\nvar router = express.Router();\r\nrouter.get('/seconds', passport.authenticate('jwt'), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {\r\n    var userid, seconds, e_1;\r\n    return __generator(this, function (_a) {\r\n        switch (_a.label) {\r\n            case 0:\r\n                _a.trys.push([0, 2, , 3]);\r\n                userid = req.user.id;\r\n                return [4 /*yield*/, db_1.default.users.secondsBrewing(userid)];\r\n            case 1:\r\n                seconds = _a.sent();\r\n                res.json(seconds);\r\n                return [3 /*break*/, 3];\r\n            case 2:\r\n                e_1 = _a.sent();\r\n                console.log(e_1);\r\n                res.status(500).json({ message: \"nope\", e: e_1 });\r\n                return [3 /*break*/, 3];\r\n            case 3: return [2 /*return*/];\r\n        }\r\n    });\r\n}); });\r\nrouter.get('/bloom', passport.authenticate('jwt'), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {\r\n    var userid, myBloom, e_2;\r\n    return __generator(this, function (_a) {\r\n        switch (_a.label) {\r\n            case 0:\r\n                _a.trys.push([0, 2, , 3]);\r\n                userid = req.user.id;\r\n                return [4 /*yield*/, db_1.default.users.myBloom(userid)];\r\n            case 1:\r\n                myBloom = _a.sent();\r\n                res.json(myBloom);\r\n                return [3 /*break*/, 3];\r\n            case 2:\r\n                e_2 = _a.sent();\r\n                console.log(e_2);\r\n                res.status(500).json({ message: \"nope\", e: e_2 });\r\n                return [3 /*break*/, 3];\r\n            case 3: return [2 /*return*/];\r\n        }\r\n    });\r\n}); });\r\n// Gets userid of person logged in without a db call. COOL! --\r\nrouter.get('/who', passport.authenticate('jwt'), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {\r\n    var userid;\r\n    return __generator(this, function (_a) {\r\n        try {\r\n            userid = req.user.id;\r\n            res.json(userid);\r\n        }\r\n        catch (e) {\r\n            console.log(e);\r\n            res.status(500).json({ message: \"nope\", e: e });\r\n        }\r\n        return [2 /*return*/];\r\n    });\r\n}); });\r\nrouter.get('/profile', passport.authenticate('jwt'), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {\r\n    var userid, profile, e_3;\r\n    return __generator(this, function (_a) {\r\n        switch (_a.label) {\r\n            case 0:\r\n                _a.trys.push([0, 2, , 3]);\r\n                userid = req.user.id;\r\n                return [4 /*yield*/, db_1.default.users.profile(userid)];\r\n            case 1:\r\n                profile = _a.sent();\r\n                res.json(profile);\r\n                return [3 /*break*/, 3];\r\n            case 2:\r\n                e_3 = _a.sent();\r\n                console.log(e_3);\r\n                res.status(500).json({ message: \"nope\", e: e_3 });\r\n                return [3 /*break*/, 3];\r\n            case 3: return [2 /*return*/];\r\n        }\r\n    });\r\n}); });\r\nrouter.get('/grams', passport.authenticate('jwt'), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {\r\n    var userid, grams, e_4;\r\n    return __generator(this, function (_a) {\r\n        switch (_a.label) {\r\n            case 0:\r\n                _a.trys.push([0, 2, , 3]);\r\n                userid = req.user.id;\r\n                return [4 /*yield*/, db_1.default.users.grams(userid)];\r\n            case 1:\r\n                grams = _a.sent();\r\n                res.json(grams);\r\n                return [3 /*break*/, 3];\r\n            case 2:\r\n                e_4 = _a.sent();\r\n                console.log(e_4);\r\n                res.status(500).json({ message: \"nope\", e: e_4 });\r\n                return [3 /*break*/, 3];\r\n            case 3: return [2 /*return*/];\r\n        }\r\n    });\r\n}); });\r\nrouter.get('/brews', passport.authenticate('jwt'), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {\r\n    var userid, brews, e_5;\r\n    return __generator(this, function (_a) {\r\n        switch (_a.label) {\r\n            case 0:\r\n                _a.trys.push([0, 2, , 3]);\r\n                userid = req.user.id;\r\n                return [4 /*yield*/, db_1.default.users.brews(userid)];\r\n            case 1:\r\n                brews = _a.sent();\r\n                res.json(brews);\r\n                return [3 /*break*/, 3];\r\n            case 2:\r\n                e_5 = _a.sent();\r\n                console.log(e_5);\r\n                res.status(500).json({ message: \"nope\", e: e_5 });\r\n                return [3 /*break*/, 3];\r\n            case 3: return [2 /*return*/];\r\n        }\r\n    });\r\n}); });\r\nexports.default = router;\r\n\n\n//# sourceURL=webpack:///./src/server/routes/api/users.ts?");
