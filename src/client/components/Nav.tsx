		...
		<div className="row d-flex justify-content-center">
			<div className="d-flex justify-content-center">
				<nav className="d-flex flex-wrap justify-content-center">
					...
					{v && <Link to="/coffeebags/new"><button className="btn btn-primary btn-sm m-2">Add Coffee</button></Link>}
					{v && <Link to="/coffeebags/all"><button className="btn btn-primary btn-sm m-2">All Coffees</button></Link>}
					{v && <Link to="/filters/new"><button className="btn btn-primary btn-sm m-2">Add Filter</button></Link>}
